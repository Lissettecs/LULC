#!/usr/bin/env python3
"""Consolida CSV parciales de un array SLURM Pipeline B en un solo resumen."""
...
def consolidar(output_dir: Path, tile: str, year: int) -> Path:
    patron = f"resumen_pipeline_b_{tile}_{year}_idx*.csv"
    ...
    salida = output_dir / f"resumen_pipeline_b_{tile}_{year}.csv"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Consolida resumen_pipeline_b_*_idx*.csv")
